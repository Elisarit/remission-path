+++
title = 'Перевод терминологии, имён и наименований'
weight = 350
+++
...
| Наименование на английском | Выбранный перевод (и ссылка на страницу разбора) | Контекст на английском | Контекст на русском |
| -------------------- | ---------------------------------------------------- | ------------------------------------- | ------------------- |
...
| Behavioral mapping (Observation) | [Картирование поведения]({{% relref "behavioral-mapping.md" %}}) | In context of substance use disorder it is the same as functional analysis (see below). | В контексте проблем наркозависимости это то же самое что функциональный анализ (см. ниже) |
| Board certified behavior analysts | | | |
| Clinical behavior analysis (CBA) | | | |
| Choice and preference assessments | | | |
| Codependency | | | |
| Cognitive-behavioral therapy (CBT) | | | |
| Community Reinforcement Approach | [Подход подкрепления сообществом]({{% relref "craft.md" %}}) | | |
